...
```bash
StateMachine$ sam logs -n StockCheckerFunction --stack-name StateMachine --tail
```
...
```bash
StateMachine$ go test -v ./functions/...
```
...
```bash
sam delete --stack-name StateMachine
```
